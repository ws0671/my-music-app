...
export default function Artist() {
  ...
  return (
    <div>
      <div className="shadow-2xl gap-10 relative h-[400px] font-rowdies box-border overflow-hidden">
        <img
          className="max-sm:rounded-full max-sm:w-[150px] max-sm:h-[150px] opacity-80 w-full object-cover object-[center_25%] h-full "
          src={artist?.images[0].url}
          alt={artist?.name}
        />
        <div className="flex justify-center items-center max-sm:py-5"></div>
